...
function addChat(data) {
  ...
  var wrap = document.createElement('div'); wrap.className = 'chat-wrapper';

  var hdr = document.createElement('div'); hdr.className = 'chat-header';
  ...
  var msg = document.createElement('div'); msg.className = 'chat-text';
  msg.innerHTML = data.text;

  var icon = document.createElement('div'); icon.className = 'chat-icon';
  icon.innerHTML = `
  ...
  M.innerHTML = data.text.replace(/<img[^>]+>/g, '');
